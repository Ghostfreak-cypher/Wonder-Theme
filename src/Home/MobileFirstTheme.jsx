...
function MobileFirstTheme() {
  return (
    <div className="MobileFirstTheme flex flex-col justify-center align-center  items-center mt-60 ">
      <h1 className="Text text-[21px]  font-thin  text-black">
      ...
      <div className="miniText w-[900px] m-8 text-[21px]">
        <h1 className="max-w-3xl mx-auto text-[22px]  text-center text-[rgb(29, 29, 31)] text-[20px] leading-[32px] font-sans">
      ...
      <h1 className="made mt-4 capitalize font-thin flex justify-center align-center gap-28  items-center ">
        <img
